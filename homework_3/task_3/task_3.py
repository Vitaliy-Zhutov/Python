...
list_letters = {1:"AEIOULNSTRАВЕИНОРСТ", 2:"DGДКЛМПУ", 3:"BCMPБГЁЬЯ",
    4:"FHVWYЙЫ", 5:"KЖЗХЦЧ", 8:"JXШЭЮ", 10:"QZФЩЪ"}

enter_word = input("Введите одно слово: ").upper() #.upper приведение букв к верхнему регистру
sum = 0
for i in enter_word:
    for k, v in list_letters.items():
        if i in v:
            sum += k
print(f"Стоимость введеного вами слова: {sum}")